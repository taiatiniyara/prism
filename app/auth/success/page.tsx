...
export default function AuthSuccessPage() {
  return (
    <div className="flex justify-center flex-col items-center text-lime-600 p-8 gap-4">
      <FaRegEnvelopeOpen size={70} />
      <p className="p-6 bg-lime-50 rounded-lg border border-lime-200 font-semibold w-[400px]">
