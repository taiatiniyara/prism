...
const sectionClassesByTone: Record<ReviewKpiSectionTone, string> = {
  ...
  lime: "space-y-1.5 rounded-md border border-lime-200/80 border-l-7 bg-lime-50/40 p-2 dark:border-lime-900/60 dark:bg-lime-950/20",
};
...
const headingClassesByTone: Record<ReviewKpiSectionTone, string> = {
  ...
  lime: "text-[11px] font-semibold uppercase tracking-wide text-lime-700 dark:text-lime-300",
};
