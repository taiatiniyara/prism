  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        data-side={side}
        // Don't dismiss the sheet when the interaction is with the DEV form-editor
        // toggles (they live outside the sheet); other outside clicks still close it.
        onInteractOutside={(event) => {
          const original = (
            event.detail as { originalEvent?: Event } | undefined
          )?.originalEvent;
          const target = original?.target as Element | null;
          if (target?.closest?.("[data-form-overrides-ui]")) {
