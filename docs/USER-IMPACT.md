...
| 14 | Energy-taxonomy vocab rename — managed lists → Strata/Provider/Category/Technology/Asset Class; item "Unit" (#2, `98cf4e0`/`b7b8473`) | ✅ dev | BMO | Managed-list screens showed old energy-dimension names → now show Strata/Provider/Category/Technology/Asset Class/Unit | Glossary note mapping old→new; BMO heads-up that taxonomy labels changed (display + list config) | ⬜ |
