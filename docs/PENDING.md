...
- ❓ **CANDIDATE OPEN — 10 legacy managed_lists DELETED (#2, 2026-08-03).** If these lists were surfaced in the Managed Lists settings screen, a BMO now sees 10 fewer lists → journey-affecting (needs a row). If they were internal/never-surfaced, no row. Flagged to #2 to confirm which. (0 data referenced them, so likely vestigial — but visibility ≠ referenced-ness.)
