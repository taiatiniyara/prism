...
>   - **Org rationalisation ✅** (#247 — organisations 54→44, 9 users reassigned, applied to p2). **`bm_participates`:** column #233 ✅ merged; #2 reports setting the 44 values (20 true / 24 false) — treat done pending #2 confirm. Non-participant purge MOOT.
