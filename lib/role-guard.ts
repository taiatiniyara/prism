...
export const ROLE_ROUTE_PREFIXES: Record<string, string[]> = {
  ...
  BLO: ["/dashboard", "/data-entry", "/profile"],
  CEO: ["/dashboard", "/data-entry", "/profile"],
  DAOF: ["/dashboard", "/data-entry", "/profile"],
  DAOH: ["/dashboard", "/data-entry", "/profile"],
  DAOO: ["/dashboard", "/data-entry", "/profile"],
  EXE: ["/dashboard", "/data-entry", "/profile"],
  EXT: ["/dashboard", "/profile"],
  MGR: ["/dashboard", "/data-entry", "/profile"],
};
