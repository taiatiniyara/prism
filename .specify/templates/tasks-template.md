...
**Tests**: Include automated test tasks whenever a story changes business
behavior, authorization, data transformation, import/export behavior, or
...
- [ ] T010 [P] Establish shared Tailwind CSS and shadcn component usage
      guidelines
...
- [ ] T011 [P] [US1] Contract test for [endpoint] in
      tests/contract/test\_[name].py
- [ ] T012 [P] [US1] Integration test for [user journey] in
...
- [ ] T015 [US1] Implement [Service] in src/services/[service].py (depends on
      T013, T014)
- [ ] T016 [US1] Implement reusable UI components with Tailwind/shadcn in
      components/
...
- [ ] T020 [P] [US2] Contract test for [endpoint] in
      tests/contract/test\_[name].py
...
- [ ] T024 [US2] Reuse or extend shared Tailwind/shadcn components in
      components/
...
- [ ] T027 [P] [US3] Contract test for [endpoint] in
      tests/contract/test\_[name].py
...
- [ ] T031 [US3] Reuse shared Tailwind/shadcn components or extract new reusable
      ones
...
- [ ] TXXX [P] Additional unit/integration tests for changed behavior in tests/
- [ ] TXXX Security hardening
- [ ] TXXX Consolidate duplicated UI into reusable components in components/
- [ ] TXXX Run `npm run lint` and capture results in PR notes
- [ ] TXXX Run `npm run build` and capture results in PR notes
