...
async function seedManagedLists() {
  ...
  const lists = [
    ...
    { name: "Data Label Category", description: "Categories for data labels" },
    { name: "Data Label Sub-Category", description: "Sub-categories for data labels" },
    { name: "Units", description: "Units of measurement" },
    { name: "Data Type", description: "Data types for validation" },
    { name: "Energy Type", description: "Energy type dimension" },
    { name: "Energy Source", description: "Energy source dimension" },
    { name: "Energy Provider", description: "Energy provider dimension" },
